...
Animation Playground makes it easy to create beautiful web animations through an intuitive interface. This guide will walk you through the process step by step.
...
2. Click on the **"Playground"** link in the navigation
3. You'll see the animation creation interface with two main panels:
   - **Configuration Panel** (left): Where you set up your animation
   - **Preview Panel** (right): Where you see your animation in action

## Animation Types

Animation Playground supports several animation types:
...
- Learn about [Sharing & Exporting](/guide/sharing-exporting) your animations
- Explore [User Accounts](/guide/user-accounts) to save and manage your work
- Check out the [Available Scripts](/available-scripts) for development workflows
...
Ready to share your creations? Learn about [Sharing & Exporting](/guide/sharing-exporting) in the next section.
